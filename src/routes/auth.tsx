  ...
  return (
    <main className="grid min-h-screen place-items-center px-4">
      <div className="glass-card w-full max-w-md p-8">
        ...
        <button onClick={() => go()} className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-input bg-white py-3 text-sm font-medium hover:bg-accent">
        ...
        <form onSubmit={go} className="space-y-3">
          ...
          <button className="w-full rounded-xl gradient-bg py-3 text-sm font-semibold shadow-[var(--shadow-glow)]">
